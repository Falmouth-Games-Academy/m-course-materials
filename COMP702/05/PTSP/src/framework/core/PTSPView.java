...
import controllers.mctsdriver.MctsDriverController;
...
public class PTSPView extends JComponent
{
    ...
    public void paintComponent(Graphics gx)
    {
        ...
        if (MctsDriverController.ActiveMctsController != null)
        	MctsDriverController.ActiveMctsController.DrawExploited(g);
